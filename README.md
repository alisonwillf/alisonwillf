# Olá, eu sou o Alison William Ferreira 👋

Desenvolvedor em constante evolução, focado em construir soluções modernas e eficientes. Atualmente, busco unir a sólida base acadêmica com tecnologias de alta performance para criar experiências digitais completas.

### 🎓 Formação e Foco Atual
- 📚 Cursando **Análise e Desenvolvimento de Sistemas** na **Faculdade São Judas**.
- 🚀 Aprofundando conhecimentos em desenvolvimento nativo com **Swift** e backend com **Golang**.
- ☁️ Estudando para as certificações **AWS Cloud Practitioner** e **Solutions Architect**.
...
- **E-mail:** [alisoninove@yahoo.com.br](mailto:alisoninove@yahoo.com.br)
